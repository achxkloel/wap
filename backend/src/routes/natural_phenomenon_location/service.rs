...
pub trait NaturalPhenomenonLocationService: Send + Sync + 'static {
    ...
    // async fn get_by_id(&self, user_id: UserId, id: NaturalPhenomenonLocationId) -> Result<NaturalPhenomenonLocation>;
    // async fn update(&self, user_id: UserId, id: NaturalPhenomenonLocationId) -> Result<NaturalPhenomenonLocation>;
...
//     }
//
//     async fn update(&self, user_id: UserId, id: NaturalPhenomenonLocationId) -> anyhow::Result<NaturalPhenomenonLocation> {
